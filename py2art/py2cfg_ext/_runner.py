...
from py2cfg_ext.builder import CFGBuilder  # type: ignore
...
def main() -> None:
    ...
    if args.debug:
        ...
        if (child := pty.fork()[0]) == 0:
            ...
            # browser script.
            from py2cfg_ext._serve import serve

            serve(args.port)
        else:
            from py2cfg_ext._debug_hooks import debug_init
            from py2cfg_ext._serve import set_pid
            ...
            from py2cfg_ext._serve import get_pid
            from py2cfg_ext._debug_hooks import get_future_id
